...
public class PanelIngreso2022 extends JPanel implements ActionListener
{
  ...
  public void actionPerformed(ActionEvent e){
   ...
   if(e.getSource()== btnIngresar){
     ...
     {
      if(usuario.equals("alex") && contra.equals("1234"))
      { 
        JOptionPane.showMessageDialog(null, "Bienvenida Administrador");
        JFramePantallaPrincipal pantallaPrincipal = new JFramePantallaPrincipal();
      }
     else
     {
